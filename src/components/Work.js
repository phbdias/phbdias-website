...
const jobs = [
  ...
  },
  {
    ...
    text: [
      ...
      "• Deployed Solidity smart contracts in distinct EVM-compatible chains (Ethereum, Avalanche, and Polygon)",
      "• Investigated blockchain state-of-the-art, mastering multiple EIPs to leverage features like gasless transactions, access control,  and upgradeability",
